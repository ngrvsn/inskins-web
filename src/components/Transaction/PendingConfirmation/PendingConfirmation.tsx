  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.mainCard}>
        ...
        <TransactionNumber transactionId={transactionId} />
        ...
        <InfoBanner variant='warning'>
          Из-за новых правил{' '}
          <span className={styles.link}>Steam Trade Protection</span>,{' '}
      ...
      <div className={styles.instructionBlock}>
        <h3 className={styles.instructionTitle}>
          1. Получили странные уведомления об отмене сделки или создании новой?
        </h3>
        <div className={styles.instructionContent}>
          ...
          <ul>
            <li>
              ...
              <span>«Защита аккаунта»</span> → <span>«Сменить пароль»</span>
            </li>
            <li>
      ...
      <InfoBanner variant='warning' greenBorder>
        Перед подтверждением обмена на телефоне - ОБЯЗАТЕЛЬНО подождите 15 сек
        на странице нашего сайта. Это нужно чтобы уберечь вас от STEAM API SCAM.
      </InfoBanner>

      <div className={styles.buttonsSection}>
        <Button variant='primary' size='large' onClick={onConfirmBrowser}>
